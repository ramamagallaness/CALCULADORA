...
public class Matrices extends JPanel {
    ...
    public Matrices() {
        ...
        btnContinuar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    ingresoMatrices.setPreferredSize(new Dimension(850 + columnas1 * 20, 50 + filas1 * 50));
        ...
        JButton btnMultiplicacionEscalar = new JButton("Multiplicación Escalar");
        ...
        JButton btnProductoMatrices = new JButton("Multiplicación");
        ...
        JButton btnDivisionMatrices = new JButton("División");
